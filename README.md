...
- `assets/dishes/menu/` — small thumbnails for every menu-list item (68 of them), cropped from the 6
...
- **The menu (`#menu` in `index.html`) now reflects the real, physical menu boards**: Breakfast, Lunch &
  Dinner, Salads, Dessert, Bubble Tea & Iced Coffee, and Coffee & Smoothies — 68 items total, each with a
  real photo thumbnail. One thing from the photographed menu still needs the owner's confirmation: item 16
  and item 20 in Lunch & Dinner are both listed as "Rice & Veggies" but priced differently ($18 vs $21.60)
  with no distinguishing detail visible in the photo.
